...
import 'package:week3_app/data/recipe_categories.dart';
...
import 'package:week3_app/widgets/search/search_bar.dart';
...
class HomeScreen extends StatelessWidget {
        ...
        SizedBox(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return _buildWrappedCategoryChip(context, category);
            },
          ),
        ),
      ],
  ...
  Widget _buildWrappedCategoryChip(BuildContext context, String category) {
    return Padding(
      ...
      child: Wrap(
        ...
        spacing: 8,
        runSpacing: 8,
        children: [_buildCategoryChip(context, category)],
      ),
    );
  }
  ...
  Widget _buildCategoryChip(BuildContext context, String label) {
    return ActionChip(
      ...
      onPressed: () {
        ...
        Navigator.pushNamed(context, '/category_recipes', arguments: label);
      },
